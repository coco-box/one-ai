...
.navbar-top-container {
  ...
  :deep(.mc-header-logo-container) {
    ...
    .mc-header-title {
      font-size: devui.$devui-font-size !important;
    }
  }
  ...
  :deep(.switch-lang-container) {
    ...
    border-radius: devui.$devui-border-radius-card;
    cursor: pointer;
...
body[ui-theme="galaxy-theme"] {
  .navbar-top-history {
    background-color: devui.$devui-global-bg;
  }
}
</style>
...
.devui-popover__content.navbar-top-history-menu {
  padding: 0;
  background-color: devui.$devui-global-bg;
  box-shadow: devui.$devui-shadow-length-connected-overlay devui.$devui-shadow;
}
</style>
