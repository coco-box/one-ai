...
.collapse-title {
  ...
  border-radius: devui.$devui-border-radius;
  font-size: devui.$devui-font-size;
  box-sizing: border-box;
  transition: font-weight devui.$devui-animation-duration-fast
      devui.$devui-animation-ease-in-out-smooth,
    background-color devui.$devui-animation-duration-fast
      devui.$devui-animation-ease-in-out-smooth;
  cursor: pointer;
}
...
.collapse-icon {
  ...
  transition: transform devui.$devui-animation-duration-slow
      devui.$devui-animation-ease-in-out-smooth;

  :deep(g path) {
    fill: devui.$devui-icon-fill;
  }
