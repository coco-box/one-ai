export default {
  ...
  home: {
    subtitle: "Intelligent chat assistant for more efficient work",
    startChat: "Start Chat",
    startChatDesc: "Begin a new conversation with AI assistant",
    chatHistory: "Chat History",
    chatHistoryDesc: "View previous conversation records",
    settings: "Settings",
    settingsDesc: "Personalized configuration and preferences",
