...
import { type ToolSet } from 'ai' // '../generate-text';
import { type ProviderMetadata } from 'ai' // '../types/provider-metadata';
import { type DeepPartial } from 'ai' // '../util/deep-partial';
...
A unique identifier for the message.
  ...
  /**
The role of the message. (The last two are compatible with ag-ui protocol)
   */
...
export type UIMessagePartRawData = {
