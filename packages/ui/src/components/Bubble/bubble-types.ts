...
import type { ComponentPropsOptions, ExtractPropTypes } from '@vue/composition-api';
...
export const bubbleProps = props as ComponentPropsOptions;

export type BubbleProps = ExtractPropTypes<typeof props>;
